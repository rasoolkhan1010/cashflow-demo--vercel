...
//   // 🔥 THE FIX: Ensure strict String comparison so the Market ID maps successfully
...
//   // 🔥 THE FIX: Protected Employee fetching that forces value setting AFTER options load
//   useEffect(() => {
//     let active = true;
//     if (editStoreId) {
//       api
...
//             // Ensure strict String comparison so HTML Select picks it up
//             if (
//               currentRow &&
...
//     // 🔥 Stringify the IDs so the Select bindings don't fail!
//     reset({
//       ...row,
